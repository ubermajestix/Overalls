...
== Overalls layout is stupid simple:
      - Places one huge semi-transparent div over the whole page.</li>
      - Adds one completely transparent div over the semi-transparent div in which to place your overlay div, it has no height.</li>
      - Appends the overalls-overlay div to the fully transparent div</li>
...
Overalls has three modes: basic, css-customizable, and blank</p>
  - Basic
  - CSS-Customizable
  - Blank
...
Done, just set "blank" to true in Overalls options: </p>
